...
Inclua um loop que permita que o usuário repita esse cálculo para novos valores de entrada todas vez que quiser.

'''
horas = int (input ("Qual horas: "))
min = int (input("Qual minutos são: "))